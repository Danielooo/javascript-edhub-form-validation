...
function validateUser(e) {
    if (e.target.value.includes("@")) usernameMessage.innerHTML = `
      De gebruikersnaam mag geen '@' bevatten
    `;
    if (!e.target.value.includes("@")) usernameMessage.innerHTML = ``;
}
function validatePassword(e) {
    if (e.target.value.length < 6) passwordMessage.innerHTML = `
      Wachtwoord moet minimaal 6 tekens bevatten
    `;
    if (e.target.value === "") passwordMessage.innerHTML = ``;
}

},{}]},["e11Rl","gLLPy"], "gLLPy", "parcelRequire401f")
